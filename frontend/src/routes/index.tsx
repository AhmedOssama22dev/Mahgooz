...
function LandingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex min-h-screen max-w-[480px] flex-col md:max-w-5xl">
        ...
        <main className="flex flex-1 flex-col gap-6 px-4 pb-8 md:px-6 md:pb-12">
          ...
          <section className="rounded-[12px] border border-clay-orange/20 bg-promo-banner p-4">
        ...
        <footer className="border-t border-border px-4 py-6 text-sm text-muted-foreground md:px-6">
